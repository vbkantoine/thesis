...
\newcommand{\NNT}{2025IPPAX074} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\begin{textblock}{10}(5.7,3)
	...
	\begin{flushright}
		%\huge{
			\fontsize{18}{22}\selectfont Extended reference prior theory for objective
			and practical inference, application to robust
			\makebox[3cm][r]{and auditable seismic fragility curves
			estimation}% \PhDTitle
			%}% 
