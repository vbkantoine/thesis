...
\newcommand{\PhDTitle}{TITRE DE LA THESE DE DOCTORAT EN MATHEMATIQUES APPLIQUEES} 	%% Titre de la thèse / Thesis title
...
\begin{textblock}{1}(\hpos,\vpos)
	\textblockcolour{white}
	\includegraphics[width=2.64cm]{media/etab/X-IPparis-RVB.eps}
\end{textblock}
