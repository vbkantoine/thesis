...
\begin{figure}[h]
    \centering
    \includegraphics[height=7cm]{figures/constr-frags/hist_post_marg_unconstrained_new_c.pdf}%
...
\begin{figure}[h!]
    \centering
    \includegraphics[height=7cm]{figures/constr-frags/hist_post_marg_constrained_new_c.pdf}
