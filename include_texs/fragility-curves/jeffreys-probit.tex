...
\begin{abstract}
    ...
    It is also implemented on the three case studies detailed in the \cref{chap:frags-intro}. 
...
a Bayesian framework that slightly differs from ours. In the appendix~\ref{app:SKreview}, we confirm that the posterior is not proper even when derived in the exact framework of the author's paper. % \cite{Straub2008}.
