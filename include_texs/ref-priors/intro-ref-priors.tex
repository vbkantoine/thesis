...
\begin{assu}\label{assu:intro-ref:jeffreysexist}
    ...
    \begin{enumerate}
        ...
        \item for any $\hat\theta\in\Theta$, there exists $\tau_1>0$ and $K>0$ such that for any $\theta\in B(\hat\theta,\tau)$
        \begin{equation}
            \EE_{Y\sim\PP_{Y|\theta}}\left[\sup_{\theta',\,\|\theta-\theta'\|<\delta} \|\nabla^2_\theta\log\ell(Y|\theta')\| \right]\leq K\quad\text{and}\quad \EE_{Y\sim\PP_{Y|\theta}}\left[\sup_{\theta',\,\|\theta-\theta'\|<\delta}\|\nabla_\theta\log\ell(Y|\theta')\|^2\right]\leq K.
        \end{equation}
