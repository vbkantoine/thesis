...
% \color{orange}
% \begin{prop}
%     When $\Theta\subset\RR^d$, is a countable union of open sets, there always exists an openly increasing sequence of compact subsets $(\Theta_i)_{i\in\NN}$ such that $\bigcup_{i\in\NN}\Theta_i=\Theta$.
% \end{prop}
