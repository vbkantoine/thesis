...
For $\mbf y\in\cY^k$ there exists a posterior density w.r.t. $\nu$ defined in  the class $[p(\cdot|\mbf y)]\in\sR/\!\propto$ where
    ...
    \end{equation}
If the posterior is proper for $\PP_{\mbf Y_k}$-a.e. $\mbf y$, the marginal density can be defined $\PP_{\mbf Y_k}$-a.e. by
    \begin{equation}
