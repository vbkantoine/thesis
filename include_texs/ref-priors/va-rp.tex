...
\begin{abstract}[\hspace*{-10pt}]
    ...
    It is mainly based on the submitted paper: \fullcite{baillie_variational_2025}
\end{abstract}
...
% We acknowledge that some challenges remain and could be the focus of potential future works.
% First, 

To go further, future work could address the implementation of the method using deeper neural networks, %Complexing in this such the architecture would 
