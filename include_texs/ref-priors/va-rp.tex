...
However,
while the theoretical expression of the reference priors is known in most cases (see the \cref{chap:intro-ref} for a comprehensive review of the reference prior theory), they suffer from their low computational feasibility.
