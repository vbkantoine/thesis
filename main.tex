...
\chapter{Appropriate constraints incorporation in the probit-lognormal reference prior%reference priors  and implementation of a properly constrained reference prior for estimating fragility curves
}\label{chap:constrained-frags}

\input{include_texs/fragility-curves/constrained-ref-probit}


\chapter{Design of experiments with constrained reference prior for robust inference% in a Bayesian framework
}\label{chap:doe}
